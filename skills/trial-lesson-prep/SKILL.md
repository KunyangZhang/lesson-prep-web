...
3. `课件生成`: build the A4 portrait classroom handout PDF from the verified question sequence, keeping it student-facing and aligned with the visible-gain flow.
...
Create a clean A4 portrait LaTeX classroom handout PDF for live annotation. Use formulas, text, TikZ, and programmatic plots precisely. Keep problem pages spacious with large writing areas. The classroom PDF should show only student-facing questions and necessary diagrams, not answer reveals, method skeletons, hint pages, or visible-gain teacher wording. Do not add decorative illustrations.
